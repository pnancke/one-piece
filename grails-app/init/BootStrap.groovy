...
class BootStrap {
    ...
    def init = { servletContext ->
        if (Environment.current == Environment.DEVELOPMENT) {
            ...
            def figure = new Figure(figName: "Figure1").save(failOnError: true)
            def figure2 = new Figure(figName: "Figure2").save(failOnError: true)
            def figure3 = new Figure(figName: "Figure3").save(failOnError: true)
            ...
            */
            ...
            def figure1 = new Figure(figName: "Figure-170301").save(failOnError: true)
            def figure2 = new Figure(figName: "Figure-170365").save(failOnError: true)
