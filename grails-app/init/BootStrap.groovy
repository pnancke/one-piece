...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def mangaEpisode = new MangaEpisode(maeName: "Manga1").save(failOnError: true)
        def mangaEpisode2 = new MangaEpisode(maeName: "Manga2").save(failOnError: true)
        def animeEpisode = new AnimeEpisode(aneName: "Anime1").save(failOnError: true)
        def animeEpisode2 = new AnimeEpisode(aneName: "Anime2").save(failOnError: true)
